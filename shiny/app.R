...
# ============================================================
# Astrocytoma, IDH-mutant Overall Survival Estimator
# Shiny app for NCDB astrocytoma, IDH-mutant calculator
#
...
#   obj$df2
#
# If astrocytoma_model_objects.rds is not present, this app will
...
# ----------------------------
df_ref$molecular_grade_group <- factor(
  df_ref$molecular_grade_group,
  levels = c(
...
grade_choices <- keep_existing_choices(grade_choices, df_ref$molecular_grade_group)
...
grade_default <- select_default(df_ref$molecular_grade_group, grade_choices)
  ...
  div(
    ...
    div(
      ...
      div(
        ...
        div(
          h1("Astrocytoma, IDH-mutant Overall Survival Estimator", class = "header-title"),
      ...
      card_body(
        ...
        div(
          ...
          div(
            ...
            tags$ul(
              tags$li(paste0("Model cohort: n = ", format(model_n, big.mark = ","), " adults with astrocytoma, IDH-mutant.")),
              tags$li("Intended use: this tool provides first-course-treatment-conditional, population-level overall survival estimates derived from the National Cancer Database."),
          ...
          div(
            ...
            tags$ul(
              ...
              tags$li("Study population: adults diagnosed from 2018-2023 with primary brain-site astrocytoma histology and NCDB brain molecular marker codes consistent with astrocytoma, IDH-mutant disease."),
              tags$li("Outcome: overall survival, measured in months from diagnosis."),
              tags$li("Predictors included in the model: age, tumor size, integrated molecular grade group, surgery extent, radiation therapy, chemotherapy, sex, race, Hispanic ethnicity, insurance, area-level income, area-level education, and Charlson-Deyo comorbidity score.")
            )
          ),
          ...
          div(
            ...
            tags$ul(
              tags$li("Model performance: training C-index 0.799, validation C-index 0.781, and overall C-index 0.794. Bootstrap optimism-corrected training C-index was 0.785."),
              tags$li("Time-dependent validation AUC/Brier estimates were 0.847/0.103 at 12 months, 0.799/0.174 at 36 months, and 0.779/0.197 at 60 months."),
              ...
              tags$li("Detailed molecular markers beyond integrated grade group, including CDKN2A/B status, ATRX, TP53, TERT, and MGMT promoter methylation, are not included in this registry-based calculator."),
              tags$li("The calculator is based on registry data and does not incorporate postoperative residual tumor volume, radiographic enhancement, recurrence, performance status, detailed radiation dose, treatment sequencing, or longitudinal treatment changes."),
...
server <- function(input, output, session) {
  ...
  newdata <- eventReactive(input$calc, {
    ...
    data.frame(
      ...
      molecular_grade_group = safe_factor(input$grade, levels(df_ref$molecular_grade_group)),
